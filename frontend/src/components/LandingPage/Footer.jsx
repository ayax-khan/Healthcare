      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
          ...
          <p className="text-gray-400">
            Revolutionize your healthcare experience with our cutting-edge
          ...
          <ul className="mt-4">
            ...
            <li className="mt-4">
              <a href="#" className="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span className="ml-3">+91 8967997966</span>
              </a>
            </li>
            <li className="mt-4">
              <a href="#" className="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span className="ml-3">biswassagar927@gmail.com</span>
              </a>
            </li>
          </ul>
        </div>
        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
          ...
          <ul className="mt-4 flex">
            <li>
              <a
                href="https://www.facebook.com/MrSagarBiswas/"
                target="_blank"
            ...
            <li className="ml-6">
              <a
                href="https://www.instagram.com/mrsagarbiswas/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li className="ml-6">
              <a
                href="https://www.youtube.com/mrsagarbiswas/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
          ...
          <p className="text-sm text-gray-400 mt-12">
            © 2023 E-Health Management System.{" "}
