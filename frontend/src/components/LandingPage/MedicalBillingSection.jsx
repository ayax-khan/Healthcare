export default function MedicalBillingSection() {
  return (
    <div className="relative bg-[#EDF2F6] z-40">
      <div className="text-center font-outfit py-[70px] md:py-[100px] col-md-9 mx-auto">
        <div>
          <h2 className="font-bold text-[24px] md:text-[34px] text-[#004B79] leading-[28px] md:leading-[42px] md:px-0 px-2">
        ...
        <div className="text-[14px] md:text-[18px] text-[#000F18] leading-[20px] md:leading-[28px] w-full m-auto md:px-0 px-2">
          <p className="pt-[14px] md:pt-[16px]">
            ...
            built a reputation for providing the highest quality of
            service and ensuring our clients are completely satisfied with
            our work.
          </p>
          <p className="pt-[14px] md:pt-[16px]">
          ...
          <p className="pt-[14px] md:pt-[16px]">
            ...
            psychology, cardiology, oncology, family medicine, internal
            medicine, allergy and immunology, neonatology, Pathology,
            urology, endocrinology, gynecology and many more.
          </p>
        </div>
      </div>
    </div>
